...
<head>
  ...
  <title>Obook Admin - Dashboard</title>
                    ...
                    case 'hoadon':
                      ...
                      switch ($act) {
                        case 'list':
                          ...
                          break;
                        case 'chitiet':
                          require_once('MVC/Views/duyetsach/detail.php');
                          break;
                        default:
                          require_once('MVC/Views/duyetsach/list.php');
                          break;
                      ...
                      switch ($act) {
                        case 'list':
                          require_once('MVC/Views/booktype/list.php');
                          break;
                        case 'chitiet':
                          require_once('MVC/Views/booktype/detail.php');
                          break;
                        default:
                          require_once('MVC/Views/booktype/list.php');
                          break;
